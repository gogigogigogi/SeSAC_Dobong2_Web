...
INSERT INTO customer (id, name, birthday) VALUES("ddd", "조현우","1992-03-17");
...
-- INSERT INTO orderlist (customer_id, product_name, quantity) VALUES("fff","귀여운 텀블러",2);
...
-- 4. WHERE 로 INNER JOIN, AND 로 WHERE 조회조건 추가
...
-- 유저 생성
CREATE USER 'user2'@'localhost' IDENTIFIED BY "8479";
